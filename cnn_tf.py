...
def get_image_size():
    ...
    # img = cv2.imread('gesturess/0/0 (1).jpg', 0)
    return img.shape
...
def cnn_model_fn(features, labels, mode):
    ...
    pool1 = tf.layers.max_pooling2d(inputs=conv11, pool_size=[2, 2], strides=2, name="pool1")
    ...
    pool2 = tf.layers.max_pooling2d(inputs=conv22, pool_size=[5, 5], strides=5, name="pool2")
...
def main(argv):
    ...
    train_input_fn = tf.estimator.inputs.numpy_input_fn(x={"x": train_images}, y=train_labels, batch_size=50,
